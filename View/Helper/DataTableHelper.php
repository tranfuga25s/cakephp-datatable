...
class DataTableHelper extends HtmlHelper {
    ...
    public $settings = array(
        ...
        'js' => array(
            ...
            'oLanguage' => array(
                "bDecimal" => ",",
                "sUrl" => '/dinamica/js/plugins/tables/datatables/locale/Spanish.json'
            ),
            'deferRender' => true,
    ...
    public function afterRender($viewFile) {
        ...
        // Agrego elemento de inicialización de formualriod e busqueda
        $jsVar = sprintf('var dataTableSettings = %s;', json_encode($this->_dtSettings));
        $this->scriptBlock($jsVar, array('block' => 'script'));
